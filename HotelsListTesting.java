...
public class HotelsListTesting {
    ...
    @Test
    void getHotelByUUID_ShouldPass() {
        try {
            UUID uuid = new UUID(2ead4186-a210-406d-a130-ba2c51b4ff78);
            Hotel hotel = HotelsList.getInstance().getHotelByUUID(uuid);
    ...
    @Test
    void getHotelByUUID_NoMatches() {
        try {
            UUID uuid = new UUID(2ead4234-a210-823d-a130-ba2c51b4ff78);
            Hotel hotel = HotelsList.getInstance().getHotelByUUID(uuid);
            String name = "Marriott of Seattle";
            String city = "Seattle";
            ArrayList<Room> rooms = new ArrayList<Room>();
